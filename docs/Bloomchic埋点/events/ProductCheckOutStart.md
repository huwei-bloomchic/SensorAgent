# ProductCheckOutStart

## 基本信息

- **事件显示名**: 结算开始(app端特有)
- **事件英文名**: `ProductCheckOutStart`
- **所属模块**: 4.【购物车】埋点
- **应埋点平台**: Android,IOS
